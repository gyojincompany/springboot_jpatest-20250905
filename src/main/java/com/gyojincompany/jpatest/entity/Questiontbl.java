package com.gyojincompany.jpatest.entity;
...
public class Questiontbl {
	...
	@Column(name = "qtitle", length = 20, nullable = false) //실제로 DB 테이블의 만들어질 필드 이름을 설정
	private String qtitle; //질문 제목
	
	@Column(name = "qcontent", length = 200, nullable = false) //실제로 DB 테이블의 만들어질 필드 이름을 설정
